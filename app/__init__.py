...
project_dir = os.path.dirname(os.path.abspath(__file__))#alchemy
app.config["SECRET_KEY"] = 'barnais strong'
app.config['SQLALCHEMY_DATABASE_URI'] = "sqlite:///{}".format(os.path.join(project_dir,"test.db"))
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['MAIL_USERNAME'] = 'banabasmwesigye3@gmail.com'
app.config['MAIL_PASSWORD'] = '100Billion'
app.config['MAIL_SERVER'] = "smtp.googlemail.com"
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_PORT'] = 587
stripe.api_key = 'cddfrr456655ttgg'
